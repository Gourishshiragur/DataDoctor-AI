...
def safe_status(
    ...
    """
    Return a normalized uppercase run status.
    """
...
def safe_pipeline_name(
    ...
    """
    Return a safe pipeline display name.
    """
...
def parse_timestamp(
    ...
    """
    Parse supported timestamp representations.
    """
...
def get_run_day(
    ...
    """
    Return the execution date used by the run-volume chart.
    """
...
def get_step_runs(
    ...
    """
    Return valid step-run dictionaries.
    """
...
def get_error_reason(
    ...
    """
    Convert a detailed error into a concise failure category.
    """
...
# ============================================================
# Enterprise health calculations
# ============================================================
...
def calculate_health_score(
    ...
    successful_runs: int,
    repaired_runs: int,
    partially_repaired_runs: int,
    failed_runs: int,
) -> float:
    """
    Calculate a weighted operational-health score.

    Weighting:

    Normal success:
        100% reliability contribution.

    Fully repaired:
        65% contribution because recovery was required.

    Partially repaired:
        25% contribution because unresolved operational
        problems remain.

    Failed:
        No positive contribution and an additional unresolved
        failure penalty.
    """
...
partially_repaired = sum(

    status

    in PARTIALLY_REPAIRED_STATUSES
...
with impact_1:
    ...
    elif partially_repaired > 0:


        st.warning(

            f"{partially_repaired} partially repaired "

            "run(s) still require validation or additional "

            "remediation before downstream data can be "
...
with impact_2:
    ...
    if repaired > 0:
        ...
        st.success(
            ...
            "intervention and prevented repaired runs from "
        ...
        st.warning(
            ...
            "Recovery resolved part of the execution path, "

            "but additional intervention is still required."
        ...
        st.info(
            ...
            "No completed recovery events are currently "

            "recorded. Continue measuring retry effort and "
...
if partially_repaired > 0:
    ...
    recommendations.append(
        ...
        (
            ...
            "Review partially repaired runs because failed or "

            "skipped execution paths may still affect data "

            "completeness and downstream consistency.",
...
# ============================================================
# Persist latest analytics summary
# ============================================================
